...
#define _nstates7	10	/* :init: */
#define minseq7	224
#define maxseq7	232
#define _endstate7	9

#define _nstates6	129	/* NVPMV */
#define minseq6	96
#define maxseq6	223
#define _endstate6	128

#define _nstates5	23	/* checkSymmetric */
#define minseq5	74
#define maxseq5	95
#define _endstate5	22

#define _nstates4	52	/* checkTransitivity */
#define minseq4	23
#define maxseq4	73
#define _endstate4	51

#define _nstates3	15	/* checkReflexivity */
#define minseq3	9
#define maxseq3	22
#define _endstate3	14

#define _nstates2	4	/* algoritmC */
#define minseq2	6
#define maxseq2	8
#define _endstate2	3

#define _nstates1	4	/* algoritmB */
#define minseq1	3
#define maxseq1	5
#define _endstate1	3

#define _nstates0	4	/* algoritmA */
#define minseq0	0
#define maxseq0	2
#define _endstate0	3
...
struct array { /* user defined type */
	int r[3];
};
...
#define PNVPMV	((P6 *)_this)
typedef struct P6 { /* NVPMV */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air6	(sizeof(P6) - Offsetof(P6, arrayCountOne) - 3*sizeof(int))

#define PcheckSymmetric	((P5 *)_this)
typedef struct P5 { /* checkSymmetric */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air5	(sizeof(P5) - Offsetof(P5, count2) - 1*sizeof(int))

#define PcheckTransitivity	((P4 *)_this)
typedef struct P4 { /* checkTransitivity */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
	...
	int count3;
	int summ;
	struct array squareR[3];
} P4;
#define Air4	0

#define PcheckReflexivity	((P3 *)_this)
typedef struct P3 { /* checkReflexivity */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, count1) - 1*sizeof(int))

#define PalgoritmC	((P2 *)_this)
typedef struct P2 { /* algoritmC */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PalgoritmB	((P1 *)_this)
typedef struct P1 { /* algoritmB */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PalgoritmA	((P0 *)_this)
typedef struct P0 { /* algoritmA */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned isReflexivity : 1;
	unsigned isTransitivity : 1;
	unsigned isSymmetric : 1;
	unsigned isPassedA : 1;
	unsigned isPassedB : 1;
	unsigned isPassedC : 1;
	int numA;
	int numB;
	int resultA;
	int resultB;
